...
public class JsmppEvictionPolicy<T> implements EvictionPolicy<T> {
    ...
    public boolean evict(EvictionConfig config, PooledObject<T> underTest, int idleCount) {
        log.debug("TYpe {}  {}", underTest.getObject().getClass().getTypeName(), underTest.getObject().getClass().getName());
        log.debug("Evict {} (idle count {})", underTest, idleCount);
        ...
        log.debug("State of SMPP session {} is {} with last activity at {} ({}ms idle)",
